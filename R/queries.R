...
# Insert a student named Mark Watney (student_id = 1), phone number 777-555-1234, 
# NO E-MAIL, graduates 2035, homeroom number 5

# change constraints of email in students table to remove NOT NULL
...
# Update (edit) Mark Watney phone number 
UPDATE students
SET phone = 7775551234
RETURNING first_name, phone
